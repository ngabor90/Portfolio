...
const translations = {
  hu: {
    ...
    resumeExperienceItem6P1: "2011 május - 2011 július",
    resumeExperienceItem6H3: "Irodai munkatárs",
    resumeExperienceItem6P2: "Educatio Kft.",
    resumeExperienceItem6P3: "Adminisztráció",
...
let resumeExperienceItem0P1 = document.getElementById(
  "resumeExperienceItem0P1",
);
let resumeExperienceItem0H3 = document.getElementById(
  "resumeExperienceItem0H3",
);
let resumeExperienceItem0P2 = document.getElementById(
  "resumeExperienceItem0P2",
);
let resumeExperienceItem0P3 = document.getElementById(
  "resumeExperienceItem0P3",
);

let resumeExperienceItem1P1 = document.getElementById(
  "resumeExperienceItem1P1",
);
let resumeExperienceItem1H3 = document.getElementById(
  "resumeExperienceItem1H3",
);
let resumeExperienceItem1P2 = document.getElementById(
  "resumeExperienceItem1P2",
);
let resumeExperienceItem1P3 = document.getElementById(
  "resumeExperienceItem1P3",
);

let resumeExperienceItem2P1 = document.getElementById(
  "resumeExperienceItem2P1",
);
let resumeExperienceItem2H3 = document.getElementById(
  "resumeExperienceItem2H3",
);
let resumeExperienceItem2P2 = document.getElementById(
  "resumeExperienceItem2P2",
);
let resumeExperienceItem2P3 = document.getElementById(
  "resumeExperienceItem2P3",
);

let resumeExperienceItem3P1 = document.getElementById(
  "resumeExperienceItem3P1",
);
let resumeExperienceItem3H3 = document.getElementById(
  "resumeExperienceItem3H3",
);
let resumeExperienceItem3P2 = document.getElementById(
  "resumeExperienceItem3P2",
);
let resumeExperienceItem3P3 = document.getElementById(
  "resumeExperienceItem3P3",
);

let resumeExperienceItem4P1 = document.getElementById(
  "resumeExperienceItem4P1",
);
let resumeExperienceItem4H3 = document.getElementById(
  "resumeExperienceItem4H3",
);
let resumeExperienceItem4P2 = document.getElementById(
  "resumeExperienceItem4P2",
);
let resumeExperienceItem4P3 = document.getElementById(
  "resumeExperienceItem4P3",
);

let resumeExperienceItem5P1 = document.getElementById(
  "resumeExperienceItem5P1",
);
let resumeExperienceItem5H3 = document.getElementById(
  "resumeExperienceItem5H3",
);
let resumeExperienceItem5P2 = document.getElementById(
  "resumeExperienceItem5P2",
);
let resumeExperienceItem5P3 = document.getElementById(
  "resumeExperienceItem5P3",
);
...
const setLanguage = (language) => {
  ...
  serviceH2.firstChild.textContent = selectedTranslations.serviceH2.replace(
    " " + selectedTranslations.serviceH2Span,
    "",
  );
  if (spanService) {
  ...
  resumeExperienceItem0P1.innerText =
    selectedTranslations.resumeExperienceItem0P1;
  resumeExperienceItem0H3.innerText =
    selectedTranslations.resumeExperienceItem0H3;
  resumeExperienceItem0P2.innerText =
    selectedTranslations.resumeExperienceItem0P2;
  resumeExperienceItem0P3.innerText =
    selectedTranslations.resumeExperienceItem0P3;

  resumeExperienceItem1P1.innerText =
    selectedTranslations.resumeExperienceItem1P1;
  resumeExperienceItem1H3.innerText =
    selectedTranslations.resumeExperienceItem1H3;
  resumeExperienceItem1P2.innerText =
    selectedTranslations.resumeExperienceItem1P2;
  resumeExperienceItem1P3.innerText =
    selectedTranslations.resumeExperienceItem1P3;

  resumeExperienceItem2P1.innerText =
    selectedTranslations.resumeExperienceItem2P1;
  resumeExperienceItem2H3.innerText =
    selectedTranslations.resumeExperienceItem2H3;
  resumeExperienceItem2P2.innerText =
    selectedTranslations.resumeExperienceItem2P2;
  resumeExperienceItem2P3.innerText =
    selectedTranslations.resumeExperienceItem2P3;

  resumeExperienceItem3P1.innerText =
    selectedTranslations.resumeExperienceItem3P1;
  resumeExperienceItem3H3.innerText =
    selectedTranslations.resumeExperienceItem3H3;
  resumeExperienceItem3P2.innerText =
    selectedTranslations.resumeExperienceItem3P2;
  resumeExperienceItem3P3.innerText =
    selectedTranslations.resumeExperienceItem3P3;

  resumeExperienceItem4P1.innerText =
    selectedTranslations.resumeExperienceItem4P1;
  resumeExperienceItem4H3.innerText =
    selectedTranslations.resumeExperienceItem4H3;
  resumeExperienceItem4P2.innerText =
    selectedTranslations.resumeExperienceItem4P2;
  resumeExperienceItem4P3.innerText =
    selectedTranslations.resumeExperienceItem4P3;

  resumeExperienceItem5P1.innerText =
    selectedTranslations.resumeExperienceItem5P1;
  resumeExperienceItem5H3.innerText =
    selectedTranslations.resumeExperienceItem5H3;
  resumeExperienceItem5P2.innerText =
    selectedTranslations.resumeExperienceItem5P2;
  resumeExperienceItem5P3.innerText =
    selectedTranslations.resumeExperienceItem5P3;

  resumeEducationP.innerText = selectedTranslations.resumeEducationP;
  resumeEducationItem1P1.innerText =
    selectedTranslations.resumeEducationItem1P1;
  resumeEducationItem1H3.innerText =
    selectedTranslations.resumeEducationItem1H3;
  resumeEducationItem1P2.innerText =
    selectedTranslations.resumeEducationItem1P2;

  resumeEducationItem2P1.innerText =
    selectedTranslations.resumeEducationItem2P1;
  resumeEducationItem2H3.innerText =
    selectedTranslations.resumeEducationItem2H3;
  resumeEducationItem2P2.innerText =
    selectedTranslations.resumeEducationItem2P2;

  resumeEducationItem3P1.innerText =
    selectedTranslations.resumeEducationItem3P1;
  resumeEducationItem3H3.innerText =
    selectedTranslations.resumeEducationItem3H3;
  resumeEducationItem3P2.innerText =
    selectedTranslations.resumeEducationItem3P2;
  resumeEducationItem3P3.innerText =
    selectedTranslations.resumeEducationItem3P3;
  ...
  resumeExperienceH2.firstChild.textContent =
    selectedTranslations.resumeExperienceH2;
  if (spanResumeExperience) {
    spanResumeExperience.textContent =
      selectedTranslations.resumeExperienceH2Span;
  }
  ...
  resumeEducationH2.firstChild.textContent =
    selectedTranslations.resumeEducationH2;
  if (spanResumeEducation) {
    spanResumeEducation.textContent =
      selectedTranslations.resumeEducationH2Span;
  }
  ...
  const resumeAboutItems = [
    {
      id: "resumeAboutItemP1",
      text: selectedTranslations.resumeAboutItemP1,
      span: selectedTranslations.resumeAboutItemP1Span,
    },
    {
      id: "resumeAboutItemP2",
      text: selectedTranslations.resumeAboutItemP2,
      span: selectedTranslations.resumeAboutItemP2Span,
    },
    {
      id: "resumeAboutItemP3",
      text: selectedTranslations.resumeAboutItemP3,
      span: selectedTranslations.resumeAboutItemP3Span,
    },
    {
      id: "resumeAboutItemP4",
      text: selectedTranslations.resumeAboutItemP4,
      span: selectedTranslations.resumeAboutItemP4Span,
    },
    {
      id: "resumeAboutItemP5",
      text: selectedTranslations.resumeAboutItemP5,
      span: selectedTranslations.resumeAboutItemP5Span,
    },
    {
      id: "resumeAboutItemP6",
      text: selectedTranslations.resumeAboutItemP6,
      span: selectedTranslations.resumeAboutItemP6Span,
    },
    {
      id: "resumeAboutItemP7",
      text: selectedTranslations.resumeAboutItemP7,
      span: selectedTranslations.resumeAboutItemP7Span,
    },
    {
      id: "resumeAboutItemP8",
      text: selectedTranslations.resumeAboutItemP8,
      span: selectedTranslations.resumeAboutItemP8Span,
    },
    {
      id: "resumeAboutItemP9",
      text: selectedTranslations.resumeAboutItemP9,
      span: selectedTranslations.resumeAboutItemP9Span,
    },
    {
      id: "resumeAboutItemP10",
      text: selectedTranslations.resumeAboutItemP10,
      span: selectedTranslations.resumeAboutItemP10Span,
    },
  ];
  ...
  document.querySelector(".input1Placeholder").placeholder =
    selectedTranslations.input1Placeholder;
  document.querySelector(".input2Placeholder").placeholder =
    selectedTranslations.input2Placeholder;
  document.querySelector(".input3Placeholder").placeholder =
    selectedTranslations.input3Placeholder;
  document.querySelector(".input4Placeholder").placeholder =
    selectedTranslations.input4Placeholder;
  document.querySelector(".input5Placeholder").placeholder =
    selectedTranslations.input5Placeholder;

  homeCV.href =
    language === "hu"
      ? "assets/Németh_Gábor_Webfejlesztő_CV.pdf"
      : "assets/Gabor_Nemeth_Web_developer_CV.pdf";
};
    ...
    .then((data) => {
      if (data.success) {
        Swal.fire({
          ...
          text:
            selectedTranslations.successText ||
        ...
        Swal.fire({
          ...
          text:
            selectedTranslations.errorText ||
